package com.flir.flironegauravapplication;
        ...
        import static com.flir.flironesdk.RenderedImage.ImageType.BlendedMSXRGBA8888Image;
...
public class MainActivity extends Activity implements Device.Delegate, FrameProcessor.Delegate, Device.StreamDelegate, Device.PowerUpdateDelegate{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RenderedImage.ImageType defaultImageType = BlendedMSXRGBA8888Image;
        frameProcessor = new FrameProcessor(this, this, EnumSet.of(RenderedImage.ImageType.VisibleAlignedRGBA8888Image,RenderedImage.ImageType.VisibleAlignedRGBA8888Image), true);
    ...
    public void onFrameProcessed(final RenderedImage renderedImage) {
        ...
        */
            if (this.imageCaptureRequested) {
                ...
                Toast.makeText(MainActivity.this,
                        "Ravi saved", Toast.LENGTH_LONG).show();
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        final String fileName = "FLIROne-saurabh" + formatedDate + ".jpg";
                        try {
        ...
        if (renderedImage.imageType() ==VisibleAlignedRGBA8888Image){
        ...
        */
            if (this.imageCaptureRequested) {
                Toast.makeText(MainActivity.this,
                        "Gaurav saved", Toast.LENGTH_LONG).show();
                imageCaptureRequested = false;
                final Context context = this;
                ...
                new AsyncTask<Void, Void, Void>() {
                    ...
                    protected Void doInBackground(Void... params) {
                        ...
                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ssZ", Locale.getDefault());
                        String formatedDate = sdf.format(new Date());
                        final String fileName = "FLIROne-ajay" + formatedDate + ".jpg";
                        try {
                            lastSavedPath = path + "/" + fileName;
                            renderedImage.getFrame().save(new File(lastSavedPath), frameProcessor);
